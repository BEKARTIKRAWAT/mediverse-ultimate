...
export default function LoginPage() {
  ...
  // Ensure demo user exists (optional, you can remove if not needed)
  useEffect(() => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setError("");
    setLoading(true);
    // Simulate a small delay (optional, for realism)
      ...
      <div className="bg-white rounded-2xl shadow-xl max-w-md w-full p-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                required
                className="w-full pl-10 pr-3 py-2 border border-gray-300 rounded-xl"
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-gradient-to-r from-blue-500 to-indigo-600 text-white py-2 rounded-xl"
          >
